...
export default async function ExploreIslayPage() {
  ...
  const config = {
    ...
    statsLine: '10 distilleries · 130 miles of coastline · 30,000+ barnacle geese · 8,000 years of history',
    sectionHeading: "A local family's guide to things to do on Islay",
    cardLinkPrefix: '/explore-islay/',
    cardKickers: {
      'islay-distilleries': 'Whisky',
      'islay-beaches': 'Beaches',
      'islay-wildlife': 'Wildlife',
      'food-and-drink': 'Food & Drink',
      'walking': 'Walking',
      'family-holidays': 'Family',
      'islay-villages': 'Villages',
      'visit-jura': 'Jura',
      'archaeology-history': 'Heritage',
      'islay-geology': 'Geology',
      'dog-friendly-islay': 'Dogs',
    },
    emptyStateMessage: 'Guide pages coming soon.',
    backLink: { href: '/accommodation', label: 'Explore our holiday accommodation' },
    crossLink: { href: '/islay-travel', label: 'Plan your trip to Islay' },
