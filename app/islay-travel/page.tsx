...
export default async function TravelToIslayPage() {
  ...
  const config = {
    ...
    statsLine: 'Ferry: 2 hours from Kennacraig · Flight: 25 minutes from Glasgow · Book 12 weeks ahead',
    sectionHeading: 'Our guide on getting to and from Islay',
    cardLinkPrefix: '/islay-travel/',
    cardKickers: {
      'ferry-to-islay': 'Ferry',
      'flights-to-islay': 'Flight',
      'planning-your-trip': 'Planning',
      'travelling-without-a-car': 'Car-Free',
      'arriving-on-islay': 'Arrival',
      'getting-around-islay': 'On-Island',
    },
    emptyStateMessage: 'Travel guide pages coming soon.',
    backLink: {
      href: '/accommodation',
      label: 'Explore our holiday accommodation',
    },
