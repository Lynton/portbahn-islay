...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: page?.seoTitle || page?.title || 'Getting to Islay | Portbahn Islay',
...
export default async function GettingHerePage() {
  ...
  // Schema markup for HowTo (getting to Islay)
  const schemaData = {
        ...
        {page?.heroImage && (
          <div className="w-full h-[40vh] relative overflow-hidden">
            <Image
              ...
              alt={page.heroImage.alt || page?.title || 'Getting to Islay'}
              fill
