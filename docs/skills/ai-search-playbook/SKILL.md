---
name: ai-search-playbook
description: Strategic framework for optimizing websites for AI-driven discovery surfaces (ChatGPT, Claude, Gemini, Perplexity, Google AI Overviews). Covers entity modeling, passage extraction, schema strategy, and multi-site coordination.
---
...
Strategic framework for optimizing websites for AI-driven discovery surfaces while maintaining human-first editorial quality.
...
**Full playbook location:** `/mnt/project/` (playbook files prefixed 01-XX through 08-XX)

**Quick reference:** See `quick-reference.md` in skill directory
