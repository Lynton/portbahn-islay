# Canonical Content Blocks  -  Final V2
**Date:** 2026-01-26
**Status:** Ready for Sanity implementation
**Version:** 2.0
**Changes from V1:** Restored personality and voice from original V2-FINAL-LL source files

---

## Overview

This document contains **all 16 canonical content blocks** for the Portbahn Islay website. Each block has:
- **Block ID**  -  Unique identifier for Sanity schema
- **Entity Type**  -  Classification for schema organization
- **Canonical Home**  -  The page where the FULL version lives
- **Teaser Used On**  -  Pages that use the TEASER version
- **Full Version**  -  Complete content for canonical home (preserves full personality)
- **Teaser Version**  -  Abbreviated content with link to canonical (preserves voice)
- **Key Facts**  -  Immutable data points that must remain consistent
...
|---|----------|-------------|----------------|-----------|
| 1 | `travel-to-islay` | Travel | Getting Here | Homepage, Property pages |
| 2 | `distilleries-overview` | Activity | Explore Islay | Homepage, Property FAQs |
| 3 | `families-children` | Activity | Explore Islay | Homepage, Property pages |
| 4 | `ferry-support` | Trust/Service | Getting Here | Homepage, Property FAQs |
| 5 | `trust-signals` | Credibility | Homepage | Property pages, About |
| 6 | `bruichladdich-proximity` | Location | Homepage | Property pages, Explore Islay |
| 7 | `portbahn-beach` | Place | Explore Islay | Homepage, Property pages |
| 8 | `shorefield-character` | Property | Shorefield page | Homepage, Explore Islay |
| 9 | `port-charlotte-village` | Place | Homepage | Property pages |
| 10 | `wildlife-geese` | Nature | Explore Islay | Homepage |
| 11 | `food-drink-islay` | Activity | Explore Islay | Homepage |
| 12 | `beaches-overview` | Place | Explore Islay | Homepage |
...
## Block 1: `travel-to-islay`

**Entity Type:** Travel
**Canonical Home:** Getting Here page (`/travel-to-islay`)
...
Make the journey part of the experience. 20 minutes outside Glasgow, after you pass Dumbarton, you're at Loch Lomond and from there you have two hours of some of the most beautiful scenery on earth, followed by a two-hour ferry journey to unwind.
...
There are certain things that are really worth bearing in mind and that will make your journey a lot easier, especially when CalMac throws a curveball with the ferries, or the mist rolls in and the plane can't land!

**Ferry from Kennacraig**

The Isle of Islay is accessible by CalMac ferry from Kennacraig on the Kintyre Peninsula to two ports - Port Ellen (2 hours 20 minutes) and Port Askaig (2 hours). Both ports are approximately 30-40 minutes' drive from our Bruichladdich properties. Annoyingly you have to book a ferry directly to one of the ports rather than just to "Islay" - which port will depend on what time you're travelling. The crossing offers beautiful views across the Sound of Jura.
...
Arrive at Kennacraig ferry terminal at least 30-45 minutes before departure or you risk being placed in the standby cue - they are strict! Once you drive onto the ferry, leave your car and head upstairs to the passenger lounges - you cannot remain in your vehicle during the crossing. Pets are allowed aboard on the passenger deck. 
...
## Block 3: `families-children`

**Entity Type:** Activity
**Canonical Home:** Explore Islay (new section)
**Teaser Used On:** Homepage, Property pages
...
## Block 4: `ferry-support`

**Entity Type:** Trust/Service
**Canonical Home:** Getting Here, Section 4 (Ferry Chaos Survival Guide)
**Teaser Used On:** Homepage, Property FAQs
...
## Block 6: `bruichladdich-proximity`
...
Portbahn Beach is our hidden gem - literally 5 minutes from our door via the war memorial path. It's three small, sheltered bays tucked into the coastline with stunning views across Loch Indaal. Safe for swimming, perfect for rock pooling with kids, and you'll almost always have it to yourselves.

There's rarley any tidal flow in Loch Indaal, making it very safe, but still plenty of rock pools and places to go crabbing. The water around Islay is cold (10-14°C typical), but it's sheltered enough for a quick dip if you're brave. One guest wrote: *"Better than the pictures - we had breakfast on Portbahn Beach every morning and saw seals."*

This is genuinely one of Islay's best kept secrets, and it's our local spot so pretty much yours to explore at will!
...
Over 90% of guests have told us they genuinley love the quirky charm and personal touches - it's what makes Shorefield special!
...
If you're a birder or nature lover, muddy knees fan, Shorefield offers something you won't find at a typical holiday rental - it's a family home built around a love of wildlife and nature.

---

### Teaser Version

Shorefield is the Jacksons' creation - they built this eco-house, planted every tree, created the wetlands and bird hides, and filled it with their art and curios. Quirky, characterful, and well-worn and well-loved - guests who book here value charm over polish. One guest called it *"like a big hug."* [View Shorefield →](/properties/shorefield)
...
| Character | Quirky, well-loved, a bit tired |
| Sleeps | 6 guests |
| Quote | "like a big hug" |

---

## Block 9: `port-charlotte-village`
...
**Lochindaal Seafood Kitchen**  -  Truly exceptional, run with huge heart by Jack and his father Iain. An absolute highlight (we'd say a MUST), are the seafood platters from the local fishermen's catch featuring oysters, langoustines, crab, lobster and mussels. You need to order the full platter 24 hours ahead and it may vary depending on catch - but it is absolutely worth planning around. Also a great whisky selection if you just want to drop in for a pint or a dram. Our guests consistently rave about this place and it's one of our favourite spots on the Rhinns.
...
Islay is exceptional for wildlife and particularly know for its birdwatching. Although you can spot a huge array of bird life all year round, timing can be everything!
...
If you're visiting between October and April, witnessing the geese is a highlight. Arrive at Loch Gruinart at dawn for the best show. Guests who've experienced this consistently describe it as one of their trip highlights. The local farmers however are a bit less enthusiastic about them and they can decimate crops!
...
Islay's food scene emphasises local seafood, lamb, venison and whisky. Dining out generally isn't cheap, but quality is high. Most guests cook meals as well in our well-equipped kitchens and eat out selectively. Here's where we recommend:
...
- **The Copper Still, Port Ellen** - amazing home roasted coffee, handmade deli sandwiches, cakes, soup and the best brownies on the planet; run with love by Mari and Joe; by ferry terminal
- **SeaSalt Bistro, Port Ellen** - pizza, pasta, seafood and steaks on the Port Ellen waterfront

**Distillery cafés**  
- **Ardbeg** (great food, good lunch stop)
...
**Port Charlotte Stores** (5-minute walk from our properties)
...
There is another smaller Co-op supermarket on the sea front at Port Ellen stocking essentials. 
...
**Dining In**
Most guests tend to cook several meals during their stay. Our kitchens are fully equipped with everything you need if that's your preference. Dining out every night can add up quickly on Islay!
...
The small car ferry runs roughly every hour from Port Askaig. No booking needed - just turn up at least 10 minutes before scheduled departure. Short queue for cars, but check the timetable for last ferry times and travel alerts - the weather and tides affect sailings.
...
For pop culture pilgrims: the boathouse where the KLF's Bill Drummond and Jimmy Cauty burned £1 million in 1994 is on Jura's Ardfin Estate, now a private golf course (I know, the irony). Scotland's Right To Roam laws do allow access, but be sensitive.

**Wildlife**

Red deer are everywhere - you'll see dozens daily. Eagles soar over the Paps. Seals and otters inhabit the coastline and regularly seen around Small Isles Bay.
...
- **Mrs Leonard's Cottage**  -  Old stone renovated cotters' cottage, sleeps 2
- **The Rusty Hut Lodge**  -  Cosy corten steel and timber, sleeps 2
- **The Black Hut Cabin**  -  Contemporary minimalist space, sleeps 2
...
If you want wilderness and enjoy consideration to detail, cosy, but wild, you'll probably love it here - we've tried to make this place a part of ourselves - simple, beautiful, contemporary accommodation in one of Scotland's most remote landscapes.

**Getting There**

To get to Jura takes two ferries from the mainland (first to Islay, then to Jura), or fly to Islay then ferry. The journey is absolutely part of the experience and that finally 5 minute leg on the wee ferry always feels special.
...
```javascript
{
  ...
  blockId: 'string', // e.g., 'travel-to-islay'
  entityType: 'string', // e.g., 'Travel'
  canonicalHome: 'string', // Page slug
...
Pages reference blocks with render mode:
```javascript
{
...
1. Edit the canonical block document only
2. All pages using that block update automatically
3. Key Facts table ensures consistency

---

## Key Facts Master Reference

These facts must be consistent across all blocks:

| Fact | Correct Value |
|------|---------------|
| Walk to Bruichladdich Distillery | 5 minutes |
| Walk to Portbahn Beach | 5 minutes (via war memorial path) |
| Drive to Port Charlotte | 5 minutes (or 40-minute walk along coast path) |
...
|---------|------|---------|
| 1.0 | 2026-01-26 | Initial version (stripped personality) |
| 2.0 | 2026-01-26 | Restored personality from V2-FINAL-LL source files; renamed `ferry-basics` to `travel-to-islay`; expanded all blocks with full original content; added personal touches throughout |
| 3.0 | 2026-01-27 | copy edited by Lynton for personality and clarification |

---

**Document Status:** ✅ Ready for Sanity implementation
**Total Blocks:** 16
**Voice:** Pi & Lynton throughout (per Tone of Voice Skill v1.1)
