 ...
 * Run with: node scripts/import-guide-pages.mjs
 */
...
const client = createClient({
  ...
  token: 'skoSL2o4NSJJL4nMVeORm81emov8Zu03UXFKZdUyeeFtq4UknjDNwhE3o2JUKW3xCnwdZ4Ip5Hr121x3sxqPU3cDi0MsOrE5Qc6zLt8TLCJK5gXVvXJctKW1nUaxPgavTxUqvt12kMZLuL7KJ2XeeZKTUhUmHJwup77gqT40KbWOdtQxoe2g',
  useCdn: false,
});
...
async function importContent() {
  ...
  console.log('📄 Importing Getting Here page...');
  try {
    ...
    console.error('❌ Error importing Getting Here page:', error.message);
  }

  // Import Explore Islay page
  console.log('📄 Importing Explore Islay page...');
  try {
    ...
    console.error('❌ Error importing Explore Islay page:', error.message);
  }

  console.log('🎉 Import complete!\n');
  console.log('Next steps:');
  console.log('1. Visit Sanity Studio to review and tweak content/tone');
  console.log('2. Add hero images to both pages');
  console.log('3. Pages will update at:');
